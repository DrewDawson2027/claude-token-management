...
- GitHub Actions `Certify` is green.
...
- Quote-reply strong user pain points with proof, not sales language.
- Move technical doubters to the exact docs or commands.
- Capture any real drain case into an issue using the token-drain template.
